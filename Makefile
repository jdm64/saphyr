...
objs = parser.o scanner.o Type.o Value.o Function.o Builder.o Instructions.o ModuleWriter.o GenCode.o Pass.o main.o
...
scanner.cpp : Scanner.l parser.cpp
	...
	sed -i -e '/insert class_h/a\#define SAVE_TOKEN sval->t_tok = new Token(filename(), matched(), lineNr());' scanner.ih
